...
class TradingJournal {
    constructor() {
        ...
        this.trades = []; // Will be loaded from Firebase
    ...
    init() {
        ...
        this.updateLanguage();
        firebase.database().ref(`users/${this.currentUserId}/trades`).once('value', snapshot => {
    ...
    addTrade() {
        ...
        firebase.database().ref(`users/${this.currentUserId}/trades`).set(this.trades);
